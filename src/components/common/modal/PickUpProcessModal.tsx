...
const PickUpProcessModal = ({
  ...
  return (
    <Div>
      <ModalDiv>
        <Header color="#B6DCBE">
          <BigTitle>픽업처리</BigTitle>
          <Exit onClick={closePickUpModal}>닫기</Exit>
        </Header>
        <ContentsDiv>
          <Box>
            <P>선택상품목록</P>
...
export default PickUpProcessModal;
